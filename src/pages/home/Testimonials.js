...
import Ceo from "../../images/team/ceo.jpeg"
            ...
            <div className="w-[800px]">
              <div className="text-center">
                <div className="text-sm lg:text-2xl mb-4 italic">
                  "Your Success in Recruitment and Technical Support is our
                  Priority. Welcome to Analogue Shifts, where we blend the
                  expertise of recruitment with the precision of technical
                  support to deliver exceptional results for your business. We
                  understand that finding top talent and providing reliable
                  technical assistance are crucial to driving your company’s
                  growth."
                </div>
                <div className="flex items-center justify-center gap-5">
                  ...
                  <div className="font-bold">
                    Kenneth Malaka
                    <span className="bold text-as mx-1">/</span>
                    CEO, Nigeria
                  </div>
                </div>
              </div>
            ...
            <div className="bg-yellow-500 grid lg:flex items-center justify-center gap-5 w-full p-9 rounded-lg">
              <div className="grid gap-5 text-center lg:text-start">
                ...
                <div className="text-gray-100 text-sm">
                  Sign up for our Jobsletter for the latest updates.
                </div>
              </div>
              <div className="grid gap-5 text-center lg:text-start">
