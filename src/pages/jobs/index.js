...
const seoData = {
  ...
  canonical: "https://analogueshifts.com/jobs",
                ...
                <div className="grid lg:col-span-6 py-16 px-3 lg:px-9">
                  <div className="grid gap-5 lg:w-96 p-4">
                    ...
                    <p>
                      ...
                      contains detailed descriptions of the available positions,
                      including the job title, location, and required
                      qualifications. Here, you'll find the latest updates and
                      developments from our recruitment company.
                    </p>
                  </div>
                </div>
                        ...
                        <div className="h-fit mb-0 overflow-hidden">
                          <p
                            dangerouslySetInnerHTML={{
                              __html: job.description.substring(0, 350) + "...",
                            }}
                          />
                        </div>
                      </div>
