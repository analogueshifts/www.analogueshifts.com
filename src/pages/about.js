                            ...
                            <div className="grid lg:grid-cols-12">
                                <div className="grid lg:col-span-6 py-16 px-3 lg:px-9">
                                    <div
                                        ...
                                        <p>
                                            AnalogueShifts is a Project
                                            Management and Talent Acquisition
                                            Company. Our mission is to solve the
                                            problem of cost for Startups and
                                            Large scale companies abroad by
                                            sourcing the best talents for
                                            clients. We are equipped with the
                                            most talented work force across the
                                            globe and we are ready to work 24/7.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div className="md:w-[700px]">
                                <div className="grid lg:flex lg:flex-col gap-5 text-center my-5">
                                    ...
                                    <p className="text-xl text-gray-500 mb-4">
                                        Our mission is to solve the problem of
                                        cost for Startups and Large scale
                                        companies abroad by sourcing the best
                                        talents for clients.
                                    </p>
                        ...
                        <div className="grid lg:flex lg:grid-cols-2 gap-5 items-center">
                            ...
                            <div className="grid lg:col-span-1 gap-5 h-full w-full">
                                ...
                                <p className="text text-gray-500 text-xl mb-0">
                                    ...
                                    Talent Acquisition Company. Our mission is
                                    to solve the problem of cost for Startups
                                    and Large scale companies abroad by sourcing
                                    the best talents for clients. We are
                                    equipped with the most talented work force
                                    across the globe and we are ready to work
                                    24/7.
                                </p>
                            </div>
                        </div>
                    ...
                    <div className="container mx-auto py-5 px-3 md:px-9 xl:px-28">
                        <div className="grid lg:flex lg:flex-row-reverse lg:grid-cols-2 gap-5 items-center">
                            ...
                            <div className="grid lg:col-span-1 gap-5 h-full w-full">
                                ...
                                <p className="text text-gray-500 text-xl mb-0">
                                    We are a dynamic and motivated team of
                                    people who share the same goal to find the
                                    right talent for your company. We offer high
                                    quality services and will help you with
                                    anything we can from the recruitment stage
                                    up until you have made a final decision. We
                                    are here to understand exactly what kind of
                                    person you want, to tailor our service to
