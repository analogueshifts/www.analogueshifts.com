...
@section('content')
    ...
    <main class="">        
        ...
        <header class="bg-dots-lighter bg-black">
            <div class="container mx-auto py-20 px-5 lg:px-28">
                <div class="grid lg:grid-cols-5 items-center justify-center">
                    <div class="grid lg:col-span-3">
                        <div class="grid gap-5 my-5 text-white text-center lg:text-start">
                            <h1 class="text-gray-100 font-bold text-3xl lg:text-5xl mb-2">The Future of Talent Recruitment</h1>
                            <p class="text-gray-100 text-lg mb-4 lg:pr-9">Your Success in Recruitment and Technical Support is our Priority. Welcome to Analogue Shifts, where we blend the expertise of recruitment with the precision of technical support to deliver exceptional results for your business. We understand that finding top talent and providing reliable technical assistance are crucial to driving your company’s growth.</p>
                            <div class="grid lg:flex px-5 lg:px-0 gap-3">
                                <a class="text-xl px-9 py-4 rounded-lg bg-as text-white hover:bg-transparent font-semibold hover:text-as hover:ring-2 ring-as" href="#features">Find Top Talents</a>
                                <a class="text-xl px-9 py-4 rounded-lg text-white bg-transparent font-semibold hover:text-as border-2 border-as" href="#!">Learn More</a>
                            </div>
                        </div>
                    </div>
                    <div class="grid lg:col-span-2 justify-center items-center"><img class="object-cover rounded h-80 w-full my-5" src="/images/dummy/1.jpg" alt="..." /></div>
                </div>
            </div>
        </header>
        ...
        <!-- Features section-->
        <section class="py-5">
            <div class="container px-5 lg:px-28 py-20">
                <div class="grid lg:grid-cols-3 gap-3">
                    ...
                    <div class="grid lg:col-span-2">
                        <div class="grid lg:grid-cols-2 gap-7">
                            <div class="grid gap-3 mb-5 px-5">
        ...
        <div class="bg-gray-900 container mx-auto py-28 px-5 lg:px-28">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        <div class="h-16 w-16 bg-yellow-50 dark:bg-yellow-800/20  flex items-center justify-center rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="w-7 h-7 stroke-as">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6 2.292m0-14.25v14.25" />
                            </svg>
                        </div>

                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Product Managers</h2>
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" class="self-center shrink-0 stroke-as w-6 h-6 mx-6">
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        <div class="h-16 w-16 bg-yellow-50 dark:bg-yellow-800/20  flex items-center justify-center rounded-full">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="self-center shrink-0 stroke-as w-6 h-6 mx-6">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 3v11.25A2.25 2.25 0 006 16.5h2.25M3.75 3h-1.5m1.5 0h16.5m0 0h1.5m-1.5 0v11.25A2.25 2.25 0 0118 16.5h-2.25m-7.5 0h7.5m-7.5 0l-1 3m8.5-3l1 3m0 0l.5 1.5m-.5-1.5h-9.5m0 0l-.5 1.5M9 11.25v1.5M12 9v3.75m3-6v6" />
                            </svg>
                        </div>

                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Project Managers</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">UI/IX</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Data Analysts</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">DevOps Engineers</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Business Analysts</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Virtual Assistants</h2>
                ...
                <a href="" class="scale-100 p-6 bg-gray-900 from-gray-700/50 via-transparent rounded-lg shadow-2xl shadow-gray-500/20 flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-as">
                    <div>
                        ...
                        <h2 class="mt-6 text-xl font-semibold text-gray-900 dark:text-white">Social Media Managers</h2>
        ...
        <!-- Testimonial section-->
        <div class="bg-white">
            <div class="container py-16 px-5 lg:px-28">
