<footer class="bg-black-500 py-4 mt-auto">
    <div class="container mx-auto py-5 px-3 md:px-9 xl:px-28">
        <div class="grid xl:flex justify-between gap-3">
            <div class="flex gap-3">
                <a class="" href="/about">Privacy</a>
            ...
            <div class="flex gap-3">
                ...
                <a class="" href="https://twitter.com/AnalogueShifts?t=vfspjJw0TwePEcAGydIHdQ&s=09" target="_blank">Twitter</a>
            </div>
        </div>
    </div>
</footer>