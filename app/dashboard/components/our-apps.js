            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 w-full pt-7">
                {Data.FeaturesData.map(el => (
                    <a
                        key={el.title}
                        href={el.url}
                        className="bg-white col-span-1 duration-300 h-max rounded-xl border border-tremor-brand-boulder200/30 p-5 flex flex-col gap-5 motion-safe:hover:scale-[1.02] transition-all duration-250">
