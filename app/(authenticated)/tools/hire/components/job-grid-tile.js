...
export default function JobGridTile({ item, index, total, handleDelete }) {
    return (
        <div
            ...
            <div className="flex items-center gap-4">
                <button
                    ...
                    className="rounded-2xl tablet:h-10  h-14 text-tremor-background-darkYellow flex justify-center items-center bg-white border border-tremor-background-darkYellow text-sm large:text-base font-semibold large:w-[163px] w-32">
                    Delete
                </button>
                <Link
